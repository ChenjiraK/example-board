...
export const apiGetBlogs = (params: any = {}) =>
...
export const apiGetComments = (params: any = {}) =>
  httpClient.get('/comments', { params });
export const apiPostComment = (params: any) =>
  httpClient.post('/comments', params);
export const apiPutComment = (params: any) =>
  httpClient.put('/comments', params);
